...
```
**Your support is appreciated!** https://ko-fi.com/raughter. **Thank you. This is a one-person all-volunteer project.**
...
• Since the WVA is relative to the previous 12 months of data for panel, WVA levels (visualized as colors) may be different in different panels for the same COVID concentration. The y-axis (copies/mL) is fixed and absolute,but the WVA levels are relative.<br> 
